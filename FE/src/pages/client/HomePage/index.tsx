  ...
  return (
    <ClientLayout>
      <div className="container mx-auto px-6 py-8">
        {/* Top carousel */}
        <div className="relative bg-[#cceeff] p-8 rounded-lg">
            ...
            {visibleEvents.map(ev => (
              <div key={ev._id} className="relative rounded-lg overflow-hidden h-[400px] group bg-gray-100">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                  <h3 className="text-[14px] text-blue-500 font-semibold mb-1 line-clamp-2">{ev.title}</h3>
                  <div className="flex items-center justify-between">
                    {/* <Text className="text-white/90">{getLocationText(ev.location)} {formatEventDate(ev.startDateTime)}</Text> */}
                    <Button
                      type="primary"
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
                    <EnvironmentOutlined />
                    <span>{getLocationText(ev.location)}</span>
                  </div>
